...
resultPromise = electronInstaller.createWindowsInstaller({
	    appDirectory: path.join('temp/Stakers_Casinorating-win32-x64'), //The path of the package file just generated
	    outputDirectory: path.join('./temp/build'), //Output path
	    authors: 'bookie', // author name
	    exe: 'Stakers_Casinorating.exe', //Find the name of the exe in appDirectory
	    ...
	    setupExe:'stakers_casinorating_bundle.exe',
	    title:'stakers_casinorating', 
	  });
